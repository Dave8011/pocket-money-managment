...
export default function App() {
  ...
  return (
    <div className="bg-slate-50 min-h-screen font-sans pb-24 md:max-w-md md:mx-auto md:border-x md:border-slate-200">
          ...
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4">
            ...
            <div>
              ...
              {pendingPayments.length === 0 ? (
                ...
                <div className="space-y-3">
                  {pendingPayments.slice(0, 3).map((item, idx) => (
                    <Card
                    ...
                    >
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <button
                          ...
                          className="bg-slate-900 text-white p-2 rounded-lg text-xs font-bold active:scale-95"
                        >
                          Pay
                        </button>
                      </div>
            ...
            <div className="grid grid-cols-4 gap-2">
              <button
                ...
                className="flex flex-col items-center justify-center p-3 bg-blue-600 text-white rounded-2xl shadow-lg shadow-blue-200 active:scale-95 transition-transform"
              >
                <Plus className="w-5 h-5 mb-1" />
                <span className="font-bold text-[10px]">Txn</span>
              </button>
              <button
                onClick={() => {
                  setModalType("bill");
                ...
                className="flex flex-col items-center justify-center p-3 bg-white border border-slate-200 text-slate-600 rounded-2xl shadow-sm active:bg-slate-50 transition-transform"
              >
                <Zap className="w-5 h-5 mb-1" />
                <span className="font-bold text-[10px]">Bill</span>
              </button>
              <button
                onClick={() => {
                  setModalType("loan");
              ...
              >
                ...
                <span className="font-bold text-[10px]">EMI</span>
              </button>
              <button
                onClick={() => {
                  setModalType("due");
                ...
                <p className="text-xl font-bold text-red-800">
                  {formatCurrency(
                    currentMonthTxns.reduce(
                      (a, t) => (t.type === "expense" ? a + t.amount : 0),
                      0
                    )
                  )}
                </p>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-slate-200 px-6 py-3 flex justify-around items-center z-40 md:max-w-md md:mx-auto">
        <button
        ...
        <button
          ...
          className={`flex flex-col items-center gap-1 ${
            activeTab === "list" ? "text-blue-600" : "text-slate-400"
          }`}
        >
